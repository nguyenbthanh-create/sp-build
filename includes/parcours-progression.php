...
(function(){
    ...
    window['SPP_STEPS_<?php echo $uid; ?>'] = <?php
        ...
        echo json_encode($js_steps, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
    ?>;
...
function sppToggle(uid, idx) {
    ...
    // Charger le contenu pédagogique via REST public
    var restUrl = '<?php echo esc_js( rest_url( "spcal/v1/grade_contenu" ) ); ?>';
    fetch(restUrl + '?grade=' + encodeURIComponent(step.grade))
